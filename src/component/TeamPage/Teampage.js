...
import TeamNavbar from './SectionOne';
      ...
      <div className="parent1">
        ...
        <div className="container">
          ...
          <div className="team-image-style">
            <img style={{ width: "70%" }} src={SueKempton} />
          </div>
          <div className="text-desc-head pt-2">
            <h3>Sue Kempton</h3>
          ...
          <div className="team-image-style">
            <img style={{ width: "70%" }} src={Elizabeth} />
          </div>
          <div className="">
            <div className="text-desc-head pt-2">
              <h3>Elizabeth (Liz)</h3>
