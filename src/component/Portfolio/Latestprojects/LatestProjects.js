                ...
                <div className="row LatestProjectSection">
                    ...
                    <div className="col-md-6 col-lg-6 col-sm-6 col-xs-12 ourProjectSectionWraper" data-aos="flip-down">
                        <div className="ourLastestSecRight">
                            <p className="txt-para">Our Services include home Staging for sellers, real estate agents, and brokers. We are well versed with A VACANT PROPERTY as well as Occupied staging. Our home staging services can work wonders in attracting the prominent home buyers and help increase the value of your home. Contact us today to find out how we can get you TOP DOLLAR in the current housing market! </p>
                        </div>
                    </div>
                </div>
            </div>
