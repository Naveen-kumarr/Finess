...
import ImageOne from '../../../../images/Sagebrush/resizeOne.jpg'
import ImageTwo from '../../../../images/Sagebrush/2.jpg'
import ImageThree from '../../../../images/Sagebrush/3.jpg'
import ImageFour from '../../../../images/Sagebrush/4.jpg'
import ImageFive from '../../../../images/Sagebrush/5.jpg'
import ImageSix from '../../../../images/Sagebrush/resizeSix.jpg'
import ImageSeven from '../../../../images/Sagebrush/7.jpg'
import ImageEight from '../../../../images/Sagebrush/8.jpg'
import ImageNine from '../../../../images/Sagebrush/9.jpg'
import ImageTen from '../../../../images/Sagebrush/10.jpg'
import ImageEleven from '../../../../images/Sagebrush/11.jpg'
import ImageTwelve from '../../../../images/Sagebrush/12.jpg'
import ImageThirteen from '../../../../images/Sagebrush/13.jpg'
import ImageFourteen from '../../../../images/Sagebrush/14.jpg'
import ImageFifteen from '../../../../images/Sagebrush/15.jpg'
import ImageSixteen from '../../../../images/Sagebrush/16.jpg'
import './Boxmodel.css'
    ...
    return (
      <>
        <div className="bg-clr">
            ...
            <div className="row mx-0">
              ...
              <div class="col-md-6 Enter_Section">
                <div id="main_content">
                  <article id="link-boxes">
                    <a ui-sref="connect" id="careers" class="gold-outliner" >
                      <img className="IM" src={ImageFifteen} />
                      <div class="overlay">
                        <div class="text-border text-border-top"></div>
                        <p onClick={this.HandleShow13}><i class="fas fa-search G_T"></i></p>
                        <div class="text-border text-border-bottom"></div>
                        <span class="borders border-top-right"></span><span class="borders border-right"></span><span class="borders border-bottom"></span><span class="borders border-left"></span><span class="borders border-top-left"></span>
                      </div></a>
                  </article>
              ...
              <div class="col-md-6 Enter_Section">
                <div id="main_content">
                  <article id="link-boxes">
                    <a ui-sref="connect" id="careers" class="gold-outliner" >
                      <img className="IM" src={ImageSixteen} />
                      <div class="overlay">
                        <div class="text-border text-border-top"></div>
                        <p onClick={this.HandleShow14}><i class="fas fa-search G_T"></i></p>
                        <div class="text-border text-border-bottom"></div>
                        <span class="borders border-top-right"></span><span class="borders border-right"></span><span class="borders border-bottom"></span><span class="borders border-left"></span><span class="borders border-top-left"></span>
                      </div></a>
                  </article>
          ...
          <Modal show={this.state.show13} onHide={this.handleClose}>
            <img class="content-ima" src={ImageFifteen} />
          </Modal>
          <Modal show={this.state.show14} onHide={this.handleClose}>
            <img class="content-ima" src={ImageSixteen} />
          </Modal>
        </div>
      </>
    );
